...
__all__ = ['Reading', 'attribute', 'reading_def', 'reading', 'attribute', 'reading_def', 'reading', 'overcast_conf']
...
reading = Reading.parse_reading(attribute, reading_def)
overcast_conf = round(reading.get_values()[2].get_confidence()*10) / 10
assert overcast_conf == 0.2